        ...
        info.update(
            {
                ...
                "tags": change_struct_type(user_config_vo.tags),
...
def UserConfigsInfo(user_config_vos, total_count, **kwargs):
    return user_config_pb2.UserConfigsInfo(
        results=list(map(functools.partial(UserConfigInfo, **kwargs), user_config_vos)),
