...
from spaceone.config.api.v1.domain_config import DomainConfig
...
class TestDomainConfigAPI(unittest.TestCase):
    ...
    def test_create_domain_config(self, mock_parse_request, *args):
        ...
        self.assertDictEqual(MessageToDict(domain_config_info.tags), params['tags'])
    ...
    def test_list_domain_configs(self, mock_parse_request, *args):
        ...
        self.assertIsInstance(domain_configs_info.results[0], domain_config_pb2.DomainConfigInfo)
